        ...
        <div className="space-y-8">
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-400">Track and manage your leave requests</p>
                </div>
            </header>
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
                        <div className="p-4 border-b border-slate-800 flex items-center gap-4">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-800 border border-slate-700 rounded-lg py-2 pl-10 pr-4 text-sm text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                                />
                            </div>
                        ...
                        <div className="divide-y divide-slate-800">
                            {loading ? (
                                ...
                                leaves.map((leave) => (
                                    <div key={leave._id} className="p-5 flex items-center justify-between hover:bg-slate-800/50 transition-colors group">
                                        <div className="flex items-center gap-4">
                                            <div className={cn(
                                                "w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-lg",
                                                leave.status === 'approved' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-slate-800 text-slate-400'
                                            )}>
                                                {leave.totalDays}
                                            </div>
                                            <div>
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span className="text-white font-bold">{leave.leaveType}</span>
                                                    <div className={cn(
